...
namespace Hushhlist
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<HostEventsRepository>();
            services.AddScoped<GiftsRepository>();
            services.AddScoped<GuestsRepository>();
            services.AddScoped<NotificationsRepository>();
            //services.AddScoped<HostEventsHelper>();
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    name: "default",
                    pattern: "{controller=HostEvent}/{action=Index}/{id?}");
